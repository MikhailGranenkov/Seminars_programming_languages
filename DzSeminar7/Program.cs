...
// Функция Аккермана принимает на вход два аргумента и
// возвращает единственное число – результат вычисления функции.
...
//         if (size <= 0)
//         {
//             return new int[0]; // Возвращаем пустой массив для неположительного размера
//         }
